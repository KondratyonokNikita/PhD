...
Далее в этой главе будем считать, что факториальное кольцо $R$ задано вместе с нормой $\elementnorm{\cdot}$.
...
Далее в этой главе будем считать, что факториальное кольцо $R$ задано вместе дробной частью $\fr{\cdot}$ и целой частью $\int{\cdot}$.
...
\begin{example}\label{example:Z[sqrt{-11}]}
    Пусть $R = \mathbb{Z}[\sqrt{-11}]$, где норма и дробная часть заданы соотношениями \ref{eq:norm_quadratic} и \ref{eq:fraction_part_quadratic}.
