...
\begin{center}
    ...
    \chapter*{ГЛАВА \arabic{chapter}.\\ АНАЛОГ RSA-КРИПТОСИСТЕМЫ В ДЕДЕКИНДОВЫХ КОЛЬЦАХ}\label{chapter:RSA-cryptosystem}
    \addcontentsline{toc}{chapter}{ГЛАВА \arabic{chapter}. АНАЛОГ RSA-КРИПТОСИСТЕМЫ В ДЕДЕКИНДОВЫХ КОЛЬЦАХ}
\end{center}
